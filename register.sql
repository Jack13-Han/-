...
CREATE TABLE `register` (
  ...
  `con_password` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` int NOT NULL,
...
(2250116, 'Tan San', 'tansan@gmail.com', '12345678', '12345678', 80882311, '営業部', '社員', '2026-04-16', '2006-04-21', '大阪', 1, '2026-04-17 06:04:26'),
(2250266, 'Han San', 'han@gmail.com', '12345678', '12345678', 8932123, '総務部', '社員', '2026-04-16', '2020-04-06', 'Juso', 1, '2026-04-17 06:21:12'),
(2250284, 'Yuuto San', 'yuuto@gmail.com', '12345678', '12345678', 184721, '開発部', '社員', '2026-04-16', '2026-04-14', '和歌山', 1, '2026-04-17 06:51:35'),
...
--
ALTER TABLE `register`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2250414;
COMMIT;
